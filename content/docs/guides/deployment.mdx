...
2. **Search index** — `build-search-index.js` scans `docs/` and generates `public/searchIndex.json`
3. **FAQ index** — `build-faq-index.js` extracts FAQ questions from `docs/faq/` into `public/faqIndex.json`
