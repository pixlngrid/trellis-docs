...
- `public/img/` — your logo image files
- `README.md`, `.gitignore`, `.vscode/` — your project files

### Options

```
npx @patriciamcphee/create-trellis-docs@latest upgrade [options]
...
:::tip
To see the full latest template, scaffold a fresh project in a temporary directory with `npx @patriciamcphee/create-trellis-docs@latest temp-docs` and diff it against your project.
:::
