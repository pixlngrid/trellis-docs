...
Once ported, register the component globally if your MDX pages use it without importing it — see [MDX components](/guides/docs/) for how to add global components.
