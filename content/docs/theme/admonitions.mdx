...
The `Callout` component renders the container, icon, optional title, and content in a single component. Admonition type determines the accent color via a `styles` record that maps each type to Tailwind classes:
