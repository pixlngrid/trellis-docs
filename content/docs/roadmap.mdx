...
Trellis already includes a [Docusaurus migration script](https://pixlngrid.github.io/trellis-docs/migrating-from-docusaurus/) that automates content, sidebar, and frontmatter conversion. The following migration paths are planned.
