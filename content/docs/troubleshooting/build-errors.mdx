---
title: Build Errors
description: Fix errors that occur during npm run build or static export, including prerender failures, missing static params, and Shiki language errors.
keywords:
  - build errors
  - prerender error
  - static params
...
- An MDX component is used that hasn't been registered in `components/docs/mdx/index.tsx`
