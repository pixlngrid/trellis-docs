...
- **Draft pages** — `draft: true` frontmatter field excludes a page from the production build, search index, and FAQ index while keeping it visible in sidebar exports for content auditing
