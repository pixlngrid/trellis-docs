...
- **Shared `getBaseUrl()` utility** — extracted from the feedback widget into `lib/feedback-api.ts` and shared between the widget and dashboard to eliminate duplication
...
- **Feedback documentation rewritten** — complete backend implementations for all four databases (MongoDB, Azure Cosmos DB, PostgreSQL, Firebase Firestore) with quick-start script commands and collapsible manual setup sections. Dashboard documentation, API contract, and troubleshooting added
- **Components Overview updated** — added Tooltip section with live demo and props table; updated FlippingCard section with correct props and link to dedicated docs page
