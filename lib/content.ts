...
export interface DocMeta {
  ...
  // config/sidebar.ts `sidebars` export (e.g., 'contributingToAlchemy').
  // Read at build time by scripts/build-sidebar-map.js to populate the
  // slug → sidebar-name lookup consumed by getSidebarForPathname.
