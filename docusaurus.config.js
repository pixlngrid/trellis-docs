...
const config = {
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/pixlngrid/trellis/edit/main',
        },
        blog: {
  ...
  themeConfig:
    ...
    ({
      ...
      metadata: [
        { property: 'og:description', content: 'Trellis — an opinionated docs framework by PixlnGrid, built on Docusaurus.' },
      ],
      navbar: {
        title: 'Trellis',
        logo: {
      ...
      footer: {
        style: 'dark',
        copyright: `\u00a9 ${new Date().getFullYear()} Trellis by PixlnGrid&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;Powered by Docusaurus`,
      },
      prism: {
